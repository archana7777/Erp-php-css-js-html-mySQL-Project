...
include_once('xpMenu.class.php');
	...
	class renderer
	{
		...
		echo "<script src='https://code.jquery.com/jquery-1.12.3.min.js' integrity='sha256-aaODHAgvwQW1bFOGXMeX+pC4PZIPsvn2h1sArYOhgXQ=' crossorigin='anonymous'></script>";
		echo "<script type='text/javascript' src='http://momentjs.com/downloads/moment-with-locales.min.js'></script>";
			...
			if (!$no_menu)
			{
				...
				echo "<h1><img src='$path_to_root/themes/exclusive_db/images/header_logo.png' alt='Tech Integra ERP'  height='20' width='120' /><span style='padding-left:300px;padding-bottom:10px;'><img id='ajaxmark' src='$indicator' align='center' style='visibility:hidden;'></span></h1>\n";
