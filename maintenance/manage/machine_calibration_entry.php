...
//end_table(1);
$sql = get_all_machine_calibration_entry($_POST['machine_code'],$_POST['start_date'],$_POST['end_date']);
$cols = array(
	_("Transaction"), 
	_("Machine name"), 
	_("Machine Code") => array('fun'=>'machine_code_link','ord'=>''), 
	_("Calibration Date") => array('name'=>'calibration_date', 'type'=>'date', 'ord'=>'desc'),
	_("Validity Start Date")=> array('name'=>'validity_start_date', 'type'=>'date', 'ord'=>'desc'),
	_("Validity End Date")=> array('name'=>'validity_end_date', 'type'=>'date', 'ord'=>'desc'),
	_("Remarks"),
