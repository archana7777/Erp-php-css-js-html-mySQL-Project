...
include_once($path_to_root . "/maintenance/includes/maintenance_request_ui.inc");
...
if (user_use_date_picker())
	...
	$_SESSION['page_title'] = _($help_context = "Define Items for Preventive Maintenance");
...
function handle_new_order()
{
    ...
    $_SESSION['adj_items'] = new items_cart(ST_MAINTPREREQ);
...
function can_process()
{
	...
	if (!check_reference($_POST['ref'], ST_MAINTPREREQ))
	{
		set_focus('ref');
		return false;
	}
...
if (isset($_POST['Process']) && can_process()){
	...
	$trans_no = add_maintenance_req_items($_SESSION['adj_items']->line_items, $_POST['AdjDate'],$_POST['ref'], $_POST['memo_'],$_POST["schedule_id"],ST_MAINTPREREQ,$_POST['StockLocation'],$emp_id,$dept_id);
...
display_order_header_req($_SESSION['adj_items'],$_POST['id']);

start_outer_table(TABLESTYLE, "width='70%'", 10);

display_maintenance_req_items($items_title, $_SESSION['adj_items']);
