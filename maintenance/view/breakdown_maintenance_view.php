...
{
	$sql="SELECT * FROM ".TB_PREF."break_down_request as req INNER JOIN ".TB_PREF."break_down_issue_entry as entry ON req.id=entry.req_id WHERE req.schedule_id=".db_escape($req_id)."";
