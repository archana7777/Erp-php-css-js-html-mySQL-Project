...
function copy_from_cart()
{
	...
	$_POST['shipping_bll_no'] = $cart->shipping_bll_no;
...
function check_quantities()
{
	...
	foreach ($_SESSION['Items']->line_items as $line=>$itm) {
		...
		if (isset($_POST['number_of_packages'.$line])) {
				$_SESSION['Items']->line_items[$line]->number_of_packages =
				  input_num('number_of_packages'.$line);
...
//text_cells(_("Shipping Bill Date:"), 'shipping_bill_date', $order->shipping_bill_date, 25, 25,
		    //_('Shipping Bill Date'),"class='tableheader2'");
end_row();
...
$th = array(_("Item Code"), _("Item Description"), 
	...
	_("Number of Packages"),_("This Delivery"), _("Price"), _("Tax Type"), _("Discount"), _("Total"));
