...
function display_credit_items()
{
    ...
    _("No of Packages"),	_("Credit Quantity"), _("Price"), _("Discount %"), _("Total"));
    table_header($th);
    ...
    foreach ($_SESSION['Items']->line_items as $line_no=>$ln_itm) {
		...
		$_POST['number_of_packages'.$line_no]=$ln_itm->number_of_packages;
   //display_error($ln_itm->number_of_packages);
    small_qty_cells(null, 'number_of_packages'.$line_no, qty_format($ln_itm->number_of_packages, '', $dec), null, null, $dec);
