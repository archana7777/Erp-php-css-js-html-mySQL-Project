...
end_row();
start_row();
label_cells(_("Dispatch Through"), $myrow["dispatch_through"], "class='tableheader2'");
label_cells(_("Destination"), $myrow["destination"], "class='tableheader2'");
label_cells(_("Terms Of Delivery"), $myrow["terms_of_delevery"], "class='tableheader2'");
end_row();
start_row();
label_cells(_("Buyer's Order Date"), sql2date($myrow["buyers_order_date"]), "class='tableheader2'");
label_cells(_("Despatch Document No"), $myrow["despatch_document_no"], "class='tableheader2'");
label_cells(_("Bill of Landing/LR-RR No"), $myrow["bill_of_landing_lr_rr_no"], "class='tableheader2'");
label_cells(_("Motor Vehicle No"), $myrow["motor_vehicle_no"], "class='tableheader2'");
end_row();
