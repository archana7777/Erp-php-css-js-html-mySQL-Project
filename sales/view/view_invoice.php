...
start_row();
label_cells(_("TDS Applicable Status"), $tds_applicable_status[$myrow["tds_applicable_status"]], "class='tableheader2'", "nowrap");
if ($myrow['tds_applicable_status']==2)
label_cells(_("TDS Amount"), number_format2($myrow["tds_amount"],2), "class='tableheader2'", "nowrap");
label_cells();
label_cells();
end_row();
start_row();
label_cells(_("Despatch Through"), $myrow["dispatch_through"], "class='tableheader2'", "nowrap");
label_cells(_("Destination"), $myrow["destination"], "class='tableheader2'", "nowrap");
label_cells(_("Terms Of Delivery"), $myrow["terms_of_delevery"], "class='tableheader2'", "nowrap");
end_row();
start_row();
label_cells(_("Buyer's Order Date"), $myrow["buyers_order_date"], "class='tableheader2'", "nowrap");
label_cells(_("Despatch Document No"), $myrow["despatch_document_no"], "class='tableheader2'", "nowrap");
label_cells(_("Bill of Landing/LR-RR No"), $myrow["bill_of_landing_lr_rr_no"], "class='tableheader2'", "nowrap");
end_row();
start_row();
label_cells(_("Motor Vehicle No"), $myrow["motor_vehicle_no"], "class='tableheader2'", "nowrap");
label_cells(_("Delivery Note No"), $myrow["delivery_note_no"], "class='tableheader2'", "nowrap");
label_cells(_("Driver's Name"), $myrow["driver_name"], "class='tableheader2'", "nowrap");

end_row();
label_cells(_("Driver's Number"), $myrow["driver_number"], "class='tableheader2'", "nowrap");
...
{
	$th = array(_("Item Code"), _("Item Description"), _("Quantity"),_("Number Of Packages"),
		_("Unit"), _("Price"), _("Discount %"), _("Total"), _("Tax Rate"));
	table_header($th);
	...
	while ($myrow2 = db_fetch($result))
	{
		...
		amount_cell($myrow2["number_of_packages"]);
        label_cell($myrow2["units"], "align=right");
        amount_cell($myrow2["unit_price"]);
        label_cell($display_discount, "nowrap align=right");
        amount_cell($value);
		label_cell($myrow2["tax_rate"], "nowrap align=center");
		end_row();
