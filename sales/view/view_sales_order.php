...
{
start_row();
label_cells(_("Subject"), $_SESSION['View']->quote_subject, "class='tableheader2'");
label_cells(_("Product Type"), $_SESSION['View']->product_type, "class='tableheader2'");
end_row();
start_row();
label_cells(_("Technical Standard"), $_SESSION['View']->technical_std_text, "class='tableheader2'");
label_cells(_("Fright Charges"), $_SESSION['View']->fright_charges_text, "class='tableheader2'");
end_row();
start_row();
label_cells(_("GST"), $_SESSION['View']->gst_text, "class='tableheader2'");
label_cells(_("F.O.R"), $_SESSION['View']->for_text, "class='tableheader2'");
end_row();
start_row();
label_cells(_("Inspection"), $_SESSION['View']->inspection_text, "class='tableheader2'");
label_cells(_("Payment"), $_SESSION['View']->payment_text, "class='tableheader2'");
end_row();
start_row();
label_cells(_("Dispatch"), $_SESSION['View']->Dispatch_text, "class='tableheader2'");
label_cells(_("Offer validity"), $_SESSION['View']->offer_validity_text, "class='tableheader2'");
end_row();
...
{
start_row();
label_cells(_("Dispatch through"), $_SESSION['View']->dispatch_through, "class='tableheader2'");
label_cells(_("Destination"), $_SESSION['View']->destination, "class='tableheader2'");
end_row();
start_row();
label_cells(_("Terms of Delivery"), $_SESSION['View']->terms_of_delevery, "class='tableheader2'");
label_cells(_("Buyers Order Date"), $_SESSION['View']->buyers_order_date, "class='tableheader2'");
end_row();
}
...
start_table(TABLESTYLE, "width='95%'");
$th = array(_("Item Code"), _("Item Description"), _("Quantity"),_("Number Of Packages"),_("Due On"), _("Unit"),
	_("Price"), _("Discount"), _("Total"),_("Tax (%)"), _("Quantity Delivered"));
table_header($th);
...
foreach ($_SESSION['View']->line_items as $stock_item) {
    ...
    label_cell($stock_item->number_of_packages);
	label_cell($stock_item->due_on);
...
$taxes = $_SESSION['View']->get_gst_taxes();
