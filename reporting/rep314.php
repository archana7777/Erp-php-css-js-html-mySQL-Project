...
function print_inventory_purchase()
{
	...
	$headers = array(_('S.No'), _('Spool No.'), _('Description'),('Inactive'));
	if ($fromsupp != '')
		$headers[4] = '';
    ...
    $rep = new FrontReport(_('Spool Listing '), "SpoolListingReport", user_pagesize(), 9, $orientation);
    if ($orientation == 'L')
	...
	while ($trans=db_fetch($res))
	{
			...
			$rep->TextCol(0, 1, $i);
			$rep->TextCol(1, 2, $trans['spool_number']);
