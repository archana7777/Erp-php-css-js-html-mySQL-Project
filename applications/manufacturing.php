...
class manufacturing_app extends application
{
	function __construct()
	{
		...
		$this->add_lapp_function(0, _("Work &Order Entry (TM-WM)"),
			"manufacturing/work_order_entry.php?", 'SA_WORKORDERENTRY', MENU_TRANSACTION);
		$this->add_lapp_function(0, _("&Return Work Orders (WM-TM)"),
			"manufacturing/return_work_orders.php?outstanding_only=1", 'SA_RETURNWORKORDERENTRY', MENU_TRANSACTION);	
