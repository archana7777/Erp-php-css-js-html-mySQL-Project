...
class customers_app extends application 
{
	function __construct() 
	{
        ...
        $this->add_lapp_function(0, _("&Packing List Against Delivery"),
			"sales/grn_packing_entry.php", 'SA_SALESDELIVERY_PACKING', MENU_TRANSACTION);			
		...
		$this->add_rapp_function(0, _("Customer &Credit Notes"),
		 ...
		 $this->add_rapp_function(0, _("&Packing List Against Customer Credit Note"),
			"sales/credit_note_packing_list_entry.php", 'SA_SALESCREDIT_PACKING', MENU_TRANSACTION);		
