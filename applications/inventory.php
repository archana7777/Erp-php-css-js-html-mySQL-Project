...
class inventory_app extends application
{
	function __construct()
	{
		...
		$this->add_lapp_function(2, _("Item Sizes "),
			"inventory/manage/size_master.php?", 'SA_SIZEMASTER', MENU_MAINTENANCE);
		$this->add_lapp_function(2, _("Item Grades"),
			"inventory/manage/grade_master.php?", 'SA_GRADEMASTER', MENU_MAINTENANCE);	
		$this->add_lapp_function(2, _("Spool List"),
			"inventory/manage/spool_list.php?", 'SA_SPOOLMASTER', MENU_MAINTENANCE);	
