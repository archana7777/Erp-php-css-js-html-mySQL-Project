...
class suppliers_app extends application 
{
  ...
  $this->add_lapp_function(0, _("&Packing List Against GRN"),
			"purchasing/grn_packing_entry.php", 'SA_GRN_PACKING', MENU_TRANSACTION);		
		...
		$this->add_rapp_function(0, _("&TDS Payments"),
			"purchasing/tds_payment.php?", 'SA_SUPPLIERPAYMNT', MENU_TRANSACTION);	
