	...
	{ 	//it is a new customer
		...
		if (isset($SysPrefs->auto_create_branch) && $SysPrefs->auto_create_branch == 1)
		{
        	add_branch($selected_id, $_POST['CustName'], $_POST['cust_ref'],
                ...
                $_POST['location'], $_POST['address'], 0, $_POST['ship_via'], $_POST['notes'], $_POST['bank_account'],$_POST['branch_gst'],$_POST['business_type'],$_POST['tax_payer_type'],$_POST['state_code'],$_POST['pin_code'],$_POST['tds_applicable'],$_POST['tds_service_type'],$_POST['pan_no'],$_POST['pan_status'],$_POST['name_on_pan']);
...
function customer_settings($selected_id) 
{
	...
	{
		table_section_title(_("Branch Taxation"));
