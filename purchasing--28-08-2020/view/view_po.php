...
$th = array(_("Item Code"), _("Item Description"), _("Quantity"), _("Unit"), _("Price"),
	_("Requested By"), _("Line Total"), _("Quantity Received"), _("Quantity Invoiced"), _("Tax Slab"));
table_header($th);
$total = $k = 0;
$overdue_items = false;
...
$tax_total = display_edit_tax_items($taxes, 6, $purchase_order->tax_included,3);
...
br();
br();
display_po_footer_in_veiw_purchase_order($purchase_order);
