...
$path_to_root = "..";
include_once($path_to_root . "/includes/ui/tds_allocation_cart.inc");
...
page(_($help_context = "TDS Payment Entry"), false, false, "", $js);
...
if (!isset($_POST['bank_account'])) { // first page call
	$_SESSION['alloc'] = new allocation(ST_SUPTDSPAYMENT, 0, get_post('supplier_id'));
...
if (isset($_GET['AddedID'])) {
	...
	submenu_print(_("&Print This Remittance"), ST_SUPTDSPAYMENT, $payment_id."-".ST_SUPTDSPAYMENT, 'prtopt');
	submenu_print(_("&Email This Remittance"), ST_SUPTDSPAYMENT, $payment_id."-".ST_SUPTDSPAYMENT, null, 1);

	submenu_view(_("View this Payment"), ST_SUPTDSPAYMENT, $payment_id);
    display_note(get_gl_view_str(ST_SUPTDSPAYMENT, $payment_id, _("View the GL &Journal Entries for this Payment")), 0, 1);
...
function check_inputs()
{
	...
	if (!check_reference($_POST['ref'], ST_SUPTDSPAYMENT))
	{
		set_focus('ref');
		return false;
	}
...
function handle_add_payment()
{
	...
	$payment_id = write_tds_supp_payment(0, $_POST['supplier_id'], $_POST['bank_account'],
...
start_form();
    ...
    ref_row(_("Reference:"), 'ref', '', $Refs->get_next(ST_SUPTDSPAYMENT, null, 
    	array('supplier'=>get_post('supplier_id'), 'date'=>get_post('DatePaid'))), false, ST_SUPTDSPAYMENT);
