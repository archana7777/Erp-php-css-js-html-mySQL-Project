...
function defaultCompany()
{
	...
	echo "<body  id='loginscreen' style='background-image:url(themes/default/images/background.jpg); background-repeat: no-repeat; align:left; background-size: 1400px 700px;' ; $onload>\n";
	...
	if (!$login_timeout) { // FA logo
    	echo "<a target='_blank' href='".$SysPrefs->power_url."'><img src='$path_to_root/themes/$def_theme/images/logo_tis.png' alt='Tech Integra ERP' height='50' onload='fixPNG(this)' border='0' ></a>";
	} else { 
