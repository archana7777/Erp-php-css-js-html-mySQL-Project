...
function can_process()
{
	...
	{
		display_error( _("Spool Code must be selected."));
		set_focus('set_no');
		return false;
	}
...
{
	add_srfurnace_details($selected_id,$_POST['date_'],$_POST['shift_id'],$_POST['sr_furnace_no'],$_POST['operator_id'],$_POST['supervisor_id'],$_POST['spool_code'],$_POST['size_id'],$_POST['coil_no'],input_num('length_in_mtr'),input_num('qty'),$_POST['start_time'],$_POST['stop_time'],$_POST['reason'],$_POST['remarks']);
	...
	if (list_updated('spool_code')|| $_POST['spool_code']!=-1)
{
	...
	$size=$spool_details['size'];
	$size_id=$spool_details['size_id'];
	$remaining_length=$spool_details['produced_length']-$spool_details['used_length'];
	$Ajax->activate('_page_body');
}
	...
	srfurnaced_spool_codes_list_row(_("Coil/Spool No:"), 'spool_code', null, true,true,$selected_id);
