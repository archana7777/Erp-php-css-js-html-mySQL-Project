	...
	if (isset($_POST['ConfirmLrpc']) && can_process())
{
 ...
 start_form();
	...
	galvanised_coils_list_row(_("Core Wire:"), 'core_wire', null, true,true,$selected_id);
	galvanised_coils_list_row(_("Outer-1:"), 'outer1', null, true,true,$selected_id);
	galvanised_coils_list_row(_("Outer-2:"), 'outer2', null, true,true,$selected_id);
	galvanised_coils_list_row(_("Outer-3:"), 'outer3', null, true,true,$selected_id);
	galvanised_coils_list_row(_("Outer-4:"), 'outer4', null, true,true,$selected_id);
	galvanised_coils_list_row(_("Outer-5:"), 'outer5', null, true,true,$selected_id);
	galvanised_coils_list_row(_("Outer-6:"), 'outer6', null, true,true,$selected_id);
	...
	{
		$core_wire_info=get_galvanised_coil_detatils($_POST['core_wire'],$selected_id);
		$core_wire_info_detatils="Length:".$core_wire_info['length_in_mtr'].", Weight:".$core_wire_info['qty'];
		label_row(_("Core Wire #"), $core_wire_info_detatils);		
	}
	if($_POST['outer1']!=-1)
	{
		$outer1_info=get_galvanised_coil_detatils($_POST['outer1'],$selected_id);
		$outer1_info_detatils="Length:".$outer1_info['length_in_mtr'].", Weight:".$outer1_info['qty'];
		label_row(_("Outer1 #"), $outer1_info_detatils);		
	}
	if($_POST['outer2']!=-1)
	{
		$outer2_info=get_galvanised_coil_detatils($_POST['outer2'],$selected_id);
		$outer2_info_detatils="Length:".$outer2_info['length_in_mtr'].", Weight:".$outer2_info['qty'];
		label_row(_("Outer2 #"), $outer2_info_detatils);		
	}
	if($_POST['outer3']!=-1)
	{
		$outer3_info=get_galvanised_coil_detatils($_POST['outer3'],$selected_id);
		$outer3_info_detatils="Length:".$outer3_info['length_in_mtr'].", Weight:".$outer3_info['qty'];
		label_row(_("Outer3 #"), $outer3_info_detatils);		
	}
	if($_POST['outer4']!=-1)
	{
		$outer4_info=get_galvanised_coil_detatils($_POST['outer4'],$selected_id);
		$outer4_info_detatils="Length:".$outer4_info['length_in_mtr'].", Weight:".$outer4_info['qty'];
		label_row(_("Outer4 #"), $outer4_info_detatils);		
	}
	if($_POST['outer5']!=-1)
	{
		$outer5_info=get_galvanised_coil_detatils($_POST['outer5'],$selected_id);
		$outer5_info_detatils="Length:".$outer5_info['length_in_mtr'].", Weight:".$outer5_info['qty'];
		label_row(_("Outer5 #"), $outer5_info_detatils);		
	}
	if($_POST['outer6']!=-1)
	{
		$outer6_info=get_galvanised_coil_detatils($_POST['outer6'],$selected_id);
		$outer6_info_detatils="Length:".$outer6_info['length_in_mtr'].", Weight:".$outer6_info['qty'];
