...
page(_($help_context = "Packing Entry"), false, false, "", $js);
...
{
	$coil_details=get_layer_winder_coil_details($_POST['coil_no'],$selected_id);
	...
	layer_winder_coil_list_row(_("Coil No:"), 'coil_no', null, true,true,$selected_id);
