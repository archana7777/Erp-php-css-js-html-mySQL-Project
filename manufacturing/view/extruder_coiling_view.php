...
$item=extrudercoiling__veiw_display($woid,$coil_no);
...
br(1);
  ...
  br();
	...
	label_row(_("Coiler No"), $item['coiler_no']);
	...
	label_row(_("Coil No"),$item['rm_coil_no']);
		label_row(_("Take Up No"),$item['rm_take_up_no']);

	
	label_row(_("Size"),$item['size2']);
	label_row(_("Length"),$item['rm_length']);
	...
	table_section(2);
	table_section_title("Final Coil Details");
	label_row(_("Final Coil No"),$item['extrudercoiling_coil_no']);
