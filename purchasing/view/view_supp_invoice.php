...
start_row();
label_cells(_("Purchase Type"), $purchase_types[$supp_trans->purchase_type], "class='tableheader2'");
label_cells(_("TDS Status"), $tds_applicable_status[$supp_trans->tds_applicable_status], "class='tableheader2'");
label_cells(_("TDS Amount"), number_format2($supp_trans->tds_amount,2), "class='tableheader2'");
end_row();
...
br();
br();
display_po_footer_in_veiw_purchase_grn($supp_trans);
br();
