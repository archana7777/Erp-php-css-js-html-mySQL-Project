...
function display_type($row)
{
	...
	return $purchase_types[$row['purchase_type']];
}
...
purchase_type_list_cell('purchase_type',null,true);
...
$sql = get_sql_for_supplier_inquiry(get_post('filterType'), get_post('TransAfterDate'), get_post('TransToDate'), get_post('supplier_id'),get_post('purchase_type'));

$cols = array(
			_("Purchase Type") => array('fun'=>'display_type'),
