...
function supplier_settings(&$supplier_id)
{
	...
	text_row(_("Supplier Name:"), 'supp_name', null, 35, 35);
	...
	text_row(_("Our Customer No:"), 'supp_account_no', null, 35, 35);
	table_section_title(_("Taxation"));
	text_row(_("GST No:"), 'gst_no', null, 35, 35);
	text_row(_("PIN Code:"), 'pin_code', null, 35, 35);
	...
	text_row(_("Bank Name/Account:"), 'bank_account', null, 35, 35);
...
if (isset($_POST['submit'])) 
{
  ...
  // ravi
	if(($_POST['business_type']==1) && ($_POST['gst_no']==''))
	{
	...
	if (key_in_foreign_table($_POST['supplier_id'], 'purch_orders', 'supplier_id'))
		{
			$input_error = 1;
			display_error(_("Cannot edit the supplier record because purchase orders have been created against this supplier."));
		}
	}
	...
	if ($input_error !=1 )
	{
		...
		if ($supplier_id) 
		{
			update_supplier($_POST['supplier_id'], $_POST['supp_name'], $_POST['supp_ref'], $_POST['address'],
				...
				$_POST['notes'], $_POST['tax_group_id'], get_post('tax_included', 0),$_POST['business_type'],$_POST['tax_payer_type'],$_POST['state_code'],$_POST['pin_code'],$_POST['tds_applicable'],$_POST['tds_service_type'],$_POST['pan_no'],$_POST['pan_status'],$_POST['name_on_pan']);
		...
		else 
		{
			add_supplier($_POST['supp_name'], $_POST['supp_ref'], $_POST['address'], $_POST['supp_address'],
				...
				$_POST['payment_discount_account'], $_POST['notes'], $_POST['tax_group_id'], check_value('tax_included'),$_POST['business_type'],$_POST['tax_payer_type'],$_POST['state_code'],$_POST['pin_code'],$_POST['tds_applicable'],$_POST['tds_service_type'],$_POST['pan_no'],$_POST['pan_status'],$_POST['name_on_pan']);
